export const CONFIG = {
  ...
  language: 'Sanskrit', // This changes the display name for your language
  wordLength: 4, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Mohini Kulkarni and Milind Nandedkar', // Put your name here so people know who made this Wordle!
  ...
  startDate: 'September 10, 2022 00:00:00', // what date and time to start your game from
